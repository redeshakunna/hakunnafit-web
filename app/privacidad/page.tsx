...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="mt-10">
      ...
      <div className="mt-3 space-y-4 text-sm leading-relaxed text-white/70 sm:text-[15px]">
        {children}
      </div>
    </section>
  );
    ...
    <>
      ...
      <main className="relative">
        <div className="mx-auto max-w-3xl px-6 py-20 sm:py-24">
          ...
          <p className="mt-3 text-sm text-white/50">Última actualización: {LAST_UPDATED}</p>

          <p className="mt-8 text-sm leading-relaxed text-white/70 sm:text-[15px]">
            HakunnaFit (operado por Hakunna Digital, en adelante &quot;HakunnaFit&quot;,
            &quot;nosotros&quot;) es una plataforma que permite a entrenadores personales
            gestionar su negocio: clientes, rutinas, agenda y pagos. Esta política explica qué
            datos recopilamos, para qué los usamos y con quién los compartimos, tanto de los
            entrenadores que usan HakunnaFit como de los clientes finales que ellos gestionan
            dentro de la plataforma.
          </p>

          <Section title="1. Quiénes somos">
            <p>
              HakunnaFit es un producto de Hakunna Digital. Si tienes preguntas sobre esta
              política o sobre tus datos, puedes escribirnos a{" "}
          ...
          <Section title="2. Datos que recopilamos">
            <p>
              ...
              negocio, correo, teléfono, ciudad, información de pago (procesada por nuestra
              pasarela, ver sección 5), fotos y textos que suben para personalizar su sitio.
            </p>
            <p>
              ...
              mediciones corporales, fotos de progreso y, si el entrenador agenda una cita con
              ellos, la información necesaria para esa cita (fecha, hora, modalidad).
            </p>
            <p>
          ...
          <Section title="3. Uso de Google Calendar">
            <p>
              ...
              entrenadores (y, si lo desean, sus clientes) sincronicen las citas creadas en la
              Agenda de HakunnaFit con su calendario personal de Google.
            </p>
            <p>
              Cuando un entrenador o cliente conecta su cuenta de Google, solicitamos únicamente
              el permiso{" "}
              <code className="rounded bg-white/10 px-1.5 py-0.5 text-[13px] text-white/80">
                calendar.events
              </code>{" "}
              (crear, editar y borrar eventos puntuales) y su correo, para poder identificar la
              cuenta conectada. No solicitamos ni accedemos a la lectura de otros eventos de su
              calendario ni a ninguna otra información de su cuenta de Google.
            </p>
            ...
            <p>
              ...
              conectar la cuenta se almacenan cifrados en nuestra base de datos y solo se usan
              para las acciones descritas arriba. El entrenador o cliente puede desconectar su
              cuenta de Google en cualquier momento desde su panel en HakunnaFit, lo que revoca
              nuestro acceso de inmediato; también puede revocarlo directamente desde{" "}
              <a
          ...
          <Section title="5. Seguridad">
            <p>
              Aplicamos medidas técnicas razonables para proteger la información: conexiones
              cifradas (HTTPS), contraseñas con hash, cookies de sesión con atributos seguros y
              acceso restringido a la base de datos. Ningún sistema es 100% infalible, pero
              trabajamos para mantener los datos protegidos frente a accesos no autorizados.
            </p>
          </Section>
          ...
          <Section title="6. Tus derechos">
            <p>
              ...
              . Si eres cliente de un entrenador que usa HakunnaFit, también puedes hacer esa
              solicitud directamente a tu entrenador, quien administra tu información dentro de
              la plataforma.
            </p>
          </Section>
          ...
          <Section title="7. Cookies">
            <p>
              ...
              entrenador y panel de super-admin). No usamos cookies de rastreo publicitario.
            </p>
          </Section>

          <Section title="8. Cambios a esta política">
            <p>
              Podemos actualizar esta política a medida que evoluciona el producto. Si hay
              cambios importantes, lo indicaremos en esta misma página con la fecha de la última
              actualización.
            </p>
          </Section>
